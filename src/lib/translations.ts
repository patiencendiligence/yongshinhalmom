...
export const translations = {
  ko: {
    ...
    landingQuote: "그대의 고유한 자취와 환경을 살펴주마.\n더 나은 하루를 위한 길잡이가 되어 줄 테니 잘 확인해보게.",
    enterOracle: "보러 가기",
    ...
    thisYear: `올해의 리포트 (${currentYear})`,
    nextYear: `내년의 리포트 (${nextYear})`,
    selectYear: "분석 연도 선택",
    chooseLevel: "분석 수준 선택",
    levelSimple: "기본 요약",
    levelDetailed: "심층 리포트 ($0.99 USD)",
  ...
  en: {
    ...
    premiumFeature: "Annual Lifestyle Report",
    unlockDetailedReport: "Need a deep-dive analysis of your lifestyle patterns?",
    unlockButton: "Purchase Report ($0.99 USD)",
    paymentSuccess: "Purchase confirmed! You can now access the full pattern analysis report.",
    freeTaste: "Summary Insight",
    lockedSectionNote: "This section applies precision algorithms and requires purchase.",
    premiumBadge: "Premium Report",
    thisYear: `${currentYear} Report`,
    nextYear: `${nextYear} Report`,
    selectYear: "Select Year for Analysis",
    chooseLevel: "Select Analysis Depth",
    levelSimple: "Basic Summary",
    levelDetailed: "Full Report ($0.99 USD)",
