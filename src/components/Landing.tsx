    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-center px-4 relative overflow-hidden">
      ...
      >
        <div className="inline-flex items-center gap-6 px-6 py-2 border border-white/10 rounded-full bg-white/5 backdrop-blur-sm">
          <span className="text-[10px] font-sans font-bold tracking-[0.3em] uppercase text-white/40">Since 2024</span>
          <div className="w-1 h-1 rounded-full bg-mythic-gold" />
          <span className="text-[10px] font-sans font-bold tracking-[0.3em] uppercase text-white/40">Traditional Wisdom</span>
        </div>
      </motion.div>
      ...
      >
        <h1 className="flex flex-col items-center mb-10">
          <span className="text-[12px] font-sans font-black tracking-[0.6em] uppercase text-mythic-gold mb-4 opacity-80">Ancient Oracle</span>
          <span className="text-8xl md:text-11xl font-serif font-black tracking-tighter leading-none mb-4 italic text-white">
            龍神<span className="text-mythic-red">婆</span>
          </span>
          <span className="text-lg md:text-xl font-serif text-white/30 italic tracking-[0.2em]">The Sacred Grandmother</span>
        </h1>
      </motion.div>
      ...
      >
        <p className="text-white/40 text-base md:text-lg font-sans leading-relaxed tracking-tight">
          "천상과 지상의 기운이 교차하는 지점에서 그대의 명운을 기록하네.<br className="hidden md:block"/>
      ...
      >
        ...
        >
          ...
          <span className="relative z-10 flex items-center gap-4">
            Enter the Oracle <Sparkles className="w-4 h-4" />
          </span>
        </button>
